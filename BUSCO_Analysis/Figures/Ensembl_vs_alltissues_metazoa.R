...
# Output
#had to change my_output to have path to directory where files were
...
#my_species was changed to have specific identification I wanted to use
my_species <- c('G.aculeatus_Ensembl_Annotations', 'G.aculeatus_Ensembl_Annotations', 'G.aculeatus_Ensembl_Annotations', 'G.aculeatus_Ensembl_Annotations', 'G.aculeatus_All_Tissues', 'G.aculeatus_All_Tissues', 'G.aculeatus_All_Tissues', 'G.aculeatus_All_Tissues')
...
my_percentage <- c(74.5, 23.0, 1.9, 0.6, 18.0, 17.4, 3.8, 60.8)
my_values <- c(3416, 1053, 89, 26, 825, 797, 173, 2789)

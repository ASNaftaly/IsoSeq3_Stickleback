#need to pull fasta sequences, protein sequences, and exons from combined sexes classification with duplicates removed or from single tissues analyses that have matched or not matched to combined sexes isoforms
#to run script: python3 Pull_seqs_exons_filtered.py <no dups or single tissue converted or excluded classification file> <fasta file> <protein faa file> <exons gtf> <output filtered fasta file> <output filtered protein faa file> <output filtered exons gtf file>
